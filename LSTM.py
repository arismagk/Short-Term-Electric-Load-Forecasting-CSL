...
def create_dataset(dataset, look_back=46):
	dataX, dataY = [], []
...
# load the dataset
dataframe = read_csv('home/aris/Downloads/data (copy)/benchmarks/daily-min-temps.csv', usecols=[1], engine='python', skipfooter=3)
X = dataframe.values
